...
const fr: Translations = {
  ...
  themes: {
    ...
    'cs-theory': 'Théorie de l’informatique',
    electronics: 'Électronique',
    signal: 'Traitement du signal',
    control: 'Automatique & robotique',
    mechanics: 'Mécanique',
  },
  disciplines: {
  ...
  subthemes: {
    ...
    messaging: 'Messaging et systèmes distribués',
    ...
    'abstract-algebra': 'Algèbre générale',
    ...
    'measure-theory': 'Mesure et intégration',
    ...
    'graph-algorithms': 'Algorithmes de graphes',
    'dynamic-programming': 'Programmation dynamique',
    computability: 'Calculabilité',
    'automata-languages': 'Automates et langages',
    logic: 'Logique',
    'type-theory': 'Théorie des types',
    'analog-circuits': 'Circuits analogiques',
    'digital-electronics': 'Électronique numérique',
    microcontrollers: 'Microcontrôleurs',
    'power-electronics': 'Électronique de puissance',
    'signals-systems': 'Signaux et systèmes',
    ...
    robotics: 'Robotique',
    'statics-dynamics': 'Statique et dynamique',
    'strength-materials': 'Résistance des matériaux',
  ...
  tracks: {
    eyebrow: 'PARCOURS',
    indexTitle: 'Parcours de mathématiques',
    indexLead:
      'Des parcours balisés à travers les mathématiques, du lycée au niveau master, avec un parcours pensé pour l’IA. Chaque parcours assemble des cours réutilisables, dont beaucoup restent à venir.',
    emptyState: 'Aucun parcours publié pour le moment. Reviens bientôt.',
    backToList: '← Retour aux parcours',
    coursesUnit: 'cours',
    upcomingBadge: 'À venir',
    optionalBadge: 'Option',
    cardCta: 'Explorer le parcours',
    audienceLabel: 'Pour',
  },
  module: {
    prev: 'Précédent',
    ...
    volunteering: [
      {
        ...
        summary:
          'Caporal-chef. Chef d’équipe incendie, conducteur d’engins (COD1 engin-pompe, COD2 poids lourd hors-chemin, COD6 échelle), équipier secours routier et secours à personne.',
      },
      {
        period: '2019 - 2020',
