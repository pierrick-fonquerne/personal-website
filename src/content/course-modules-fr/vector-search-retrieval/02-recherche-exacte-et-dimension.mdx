...
order: 2
title: Recherche exacte et malediction de la dimension
subtitle: 'Comparer tous les vecteurs donne la reponse parfaite. Voici son prix, et le piege que la grande dimension tend a notre intuition.'
estimatedMinutes: 28
published: true
---
...
<Callout kind="note" title="Distance ou similarite, peu importe ici">
...
<Callout kind="info" title="Le fil rouge : pourquoi garder quand meme le Flat">
...
## La malediction de la dimension
...
<Callout kind="tip" title="Le meme raisonnement pour les angles">
