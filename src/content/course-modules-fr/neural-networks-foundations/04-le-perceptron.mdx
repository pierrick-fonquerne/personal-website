...
<Callout kind="note" title="Pourquoi le perceptron pur ne se contente pas de la « moyenne des poids »">
Une idée naïve : faire converger en moyennant les $w_t$ obtenus à chaque itération. Cette stratégie marche aussi (c'est le *voted perceptron* de Freund et Schapire (1999)), mais elle exige de garder un historique et de pondérer chaque $w_t$ par sa durée de vie. Le Pocket Algorithm est plus simple : un seul $(w, b)$ stocké, mis à jour seulement quand on fait strictement mieux.
</Callout>
...
- Gallant, S. I. (1990). « Perceptron-Based Learning Algorithms ». *IEEE Transactions on Neural Networks* 1(2), 179-191. (Introduction du Pocket Algorithm.) [DOI 10.1109/72.80230](https://doi.org/10.1109/72.80230)
