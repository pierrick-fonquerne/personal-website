...
<Callout kind="tip" title="Corrigé de l'exercice 1 : calcul direct">
...
<Callout kind="tip" title="Corrigé de l'exercice 2 : construire un neurone AND">
...
**Autres solutions valides.** Le triplet $(1, 1, -0{,}5)$ fonctionne aussi (à vérifier en refaisant les quatre cas).
...
<InteractivePrint
  ...
  description="Quiz à choix multiples qui vérifie les acquis du chapitre : l'opération d'un neurone, le rôle des poids et du biais, et la limite XOR. Sept questions avec explication de la bonne réponse à la validation. À faire en ligne pour le scoring automatique."
>
  <Quiz
    client:load
