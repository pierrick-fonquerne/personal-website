...
Ton cerveau contient environ **86 milliards de neurones** (Azevedo et al., 2009). Chaque neurone reçoit des signaux électriques d'autres neurones via ses _dendrites_, intègre ces signaux dans son corps cellulaire, et décide selon un seuil interne s'il doit lui-même envoyer un signal le long de son _axone_.
...
>
  <NeuronDiagram
    ...
    toggleLabel="Fonction d'activation"
    diagramLabel="Diagramme du neurone"
  />
</InteractivePrint>
...
<Formula caption="Forme développée">y = f( x₁·w₁ + x₂·w₂ + x₃·w₃ + b )</Formula>
...
<Callout kind="tip" title="Lis l'équation à voix haute">
  La version la plus utile pour s'entraîner à lire les maths : *« y est égal à f appliquée à la
  somme, pour i allant de un à n, des produits w i fois x i, plus b. »* Cette phrase verbale doit
  devenir un réflexe. Quand tu rencontreras une équation plus complexe plus tard, tu pourras la lire
  de la même façon, morceau par morceau.
</Callout>
...
<Callout kind="note">
  Le neurone artificiel est une caricature du neurone biologique. Un vrai neurone est dynamique dans
  le temps, communique par impulsions discrètes, et possède une chimie interne complexe. Ces
  différences sortent du périmètre de ce cours, qui se concentre sur les modèles dominants en
  pratique. Elles font l'objet d'une recherche active autour du calcul neuromorphique et des réseaux
...
| 1969  | **Minsky & Papert** publient _Perceptrons_ et démontrent qu'un seul neurone ne peut pas apprendre <Term slug="xor">XOR</Term>. Premier coup d'arrêt sérieux à l'enthousiasme.                                   |
...
Un hyperplan partitionne l'espace en deux **demi-espaces** : celui où $\mathbf{w} \cdot \mathbf{x} + b > 0$ (le neurone _s'active_) et celui où $\mathbf{w} \cdot \mathbf{x} + b < 0$ (le neurone _ne s'active pas_). Un neurone à seuil est exactement cette opération de partition.
...
<Callout kind="warn" title="Le piège historique">
  En 1969, Minsky et Papert démontrent cette limite formellement. Beaucoup en concluent, à tort, que
  les réseaux de neurones sont une impasse. Les financements s'effondrent. La solution, les réseaux
  **multi-couches**, existait pourtant déjà en théorie. Il faudra attendre 1986 et la
  backpropagation pour pouvoir les entraîner efficacement. Sujet des chapitres 5 et 7.
</Callout>

## Le rôle du biais, visuellement

Sans biais, la droite que trace le neurone passe forcément par l'origine. C'est une contrainte forte : la plupart des problèmes réels ont une frontière de décision qui n'est _pas_ à l'origine.
...
- Azevedo, F. A. et al. (2009). « Equal numbers of neuronal and nonneuronal cells make the human brain an isotropically scaled-up primate brain. » _Journal of Comparative Neurology_ 513(5), 532-541. [DOI 10.1002/cne.21974](https://doi.org/10.1002/cne.21974)
- McCulloch, W. & Pitts, W. (1943). « A Logical Calculus of Ideas Immanent in Nervous Activity. » _Bulletin of Mathematical Biophysics_ 5(4), 115-133. [DOI 10.1007/BF02478259](https://doi.org/10.1007/BF02478259)
- Hebb, D. O. (1949). _The Organization of Behavior_. Wiley. [Archive.org](https://archive.org/details/in.ernet.dli.2015.226341)
...
- Rumelhart, D. E., Hinton, G. E. & Williams, R. J. (1986). « Learning representations by back-propagating errors. » _Nature_ 323(6088), 533-536. [DOI 10.1038/323533a0](https://doi.org/10.1038/323533a0)
- Krizhevsky, A., Sutskever, I. & Hinton, G. E. (2012). « ImageNet Classification with Deep Convolutional Neural Networks. » _NeurIPS_ 25. [Lien NeurIPS](https://papers.nips.cc/paper/2012/hash/c399862d3b9d6b76c8436e924a68c45b-Abstract.html)
- Lighthill, J. (1973). _Artificial Intelligence: A General Survey_. Science Research Council, Royaume-Uni. [Archive.org](https://archive.org/details/lighthill-report)

### Pour aller plus loin

- Goodfellow, I., Bengio, Y. & Courville, A. (2016). _Deep Learning_. MIT Press. Chapitre 6 sur les réseaux feed-forward. [deeplearningbook.org](https://www.deeplearningbook.org/)
- Bishop, C. M. (2006). _Pattern Recognition and Machine Learning_. Springer. Chapitre 5 sur les réseaux de neurones.
- Hastie, T., Tibshirani, R. & Friedman, J. (2009). _The Elements of Statistical Learning_. Springer. Chapitre 11. [stanford.edu PDF gratuit](https://hastie.su.domains/ElemStatLearn/)
...
<InteractivePrint
  ...
  description="Quiz à choix multiples qui vérifie les acquis du chapitre : l'opération d'un neurone, le rôle des poids et du biais, et la limite XOR. Cinq questions avec explication de la bonne réponse à la validation. À faire en ligne pour le scoring automatique."
>
  <Quiz
    client:load
    ...
    questions={[
      {
        ...
        answer: 1,
        explain:
          "Le neurone calcule z = Σ wᵢ xᵢ + b. C'est une combinaison linéaire, pas un produit ni une moyenne.",
      },
      {
        ...
        answer: 2,
        explain:
          'Un neurone trace une droite. Les cas positifs de XOR sont en diagonale, donc non séparables par une droite unique.',
      },
      {
        ...
        answer: 1,
        explain:
          "Les poids fixent l'orientation de la droite, le biais sa position. Sans biais, la droite passe forcément par l'origine.",
      },
      {
        ...
        answer: 1,
        explain:
          'f compresse ou réoriente la somme pondérée. Sans elle, empiler des neurones reviendrait à une simple combinaison linéaire, et un réseau profond perdrait toute sa puissance expressive.',
      },
      {
        ...
        answer: 1,
        explain:
          "Le neurone artificiel reprend l'idée des entrées pondérées et du seuil, mais il ignore la dimension temporelle, les impulsions discrètes et la chimie synaptique. C'est une caricature utile, pas une réplique.",
      },
    ]}
  />
</InteractivePrint>
