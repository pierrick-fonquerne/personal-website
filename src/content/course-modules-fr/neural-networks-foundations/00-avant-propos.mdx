...
<MermaidDiagram
  client:visible
  caption="Quatre-vingts ans en huit dates"
  definition={`timeline
    title Jalons des réseaux de neurones
    1943 : McCulloch et Pitts
         : Modèle du neurone formel
    1958 : Rosenblatt
         : Perceptron qui apprend
    1969 : Minsky et Papert
         : Limites de XOR
    1986 : Rumelhart, Hinton, Williams
         : Backpropagation
    1998 : LeCun
         : LeNet et la vision convolutionnelle
    2012 : Krizhevsky, Sutskever, Hinton
         : AlexNet et l'explosion GPU
    2017 : Vaswani et al.
         : Transformer et attention
    2020+ : OpenAI, Anthropic, Google
...
<MermaidDiagram
  client:visible
  caption="Dépendances logiques : qui suppose qui"
  definition={`flowchart LR
    ...
    ch6[6. Forward + coût]
    ch7[7. Dérivées]
    ch8[8. Backpropagation]
    ch9[9. Gradient descent]
    ch10[10. Régularisation]
    ch11[11. Initialisation]
    ch12[12. Optimiseurs]
    ch1 --> ch2
    ch2 --> ch3
    ch3 --> ch4
