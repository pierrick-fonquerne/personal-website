...
Note historique. Les neurones originaux de McCulloch et Pitts en quarante-trois et le perceptron de Rosenblatt en cinquante-huit utilisaient une fonction seuil binaire : sortie un si la somme dépasse zéro, sortie zéro sinon. Pas de nuance. Le passage à la sigmoïde, puis plus tard à ReLU, est historiquement lié à la backpropagation de quatre-vingt-six, qui exige une fonction d'activation dérivable pour propager le gradient. La sigmoïde te donne une intuition plus douce ici, mais le neurone le plus simple, mathématiquement, est celui à seuil.
