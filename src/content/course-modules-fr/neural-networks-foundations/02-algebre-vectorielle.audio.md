...
En dimension deux, on vérifie que ce thêta algébrique coïncide avec l'angle géométrique euclidien : il suffit de poser x selon le premier axe et w en coordonnées polaires, et le calcul direct donne cosinus thêta égal cosinus de l'angle géométrique.
