...
**Lemma 1 (lower bound).** _For every $t \geq 0$, $w_t \cdot w^_ \geq t \gamma$.\*
...
**Step 1.** The <Term slug="cauchy-schwarz">Cauchy-Schwarz</Term> inequality says, for two vectors $u, v$:
...
Picture four squares of a chessboard: the diagonals alternate (two whites at bottom-left and top-right, two blacks at top-left and bottom-right). No single straight line can separate the whites from the blacks. That is exactly the situation of the <Term slug="xor">XOR</Term> function.
...
Marvin <Term slug="minsky-papert">Minsky and Seymour Papert</Term> publish _Perceptrons_ in 1969, the central chapter of which proves this impossibility and generalises it to a whole family of "non-local" functions. Their rigorous analysis contributed to a withdrawal of public funding for neural network research, a period we now call the first <Term slug="hiver-de-l-ia">AI winter</Term>. Recovery had to wait for Hopfield in 1982 and the rediscovery of <Term slug="backpropagation">backpropagation</Term> by Rumelhart, Hinton and Williams in 1986.
