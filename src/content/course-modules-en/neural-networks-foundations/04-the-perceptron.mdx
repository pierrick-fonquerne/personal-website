...
<HyperplaneGeometry client:load locale="en" />
...
<PerceptronGeometricStepper client:load locale="en" />
...
<NovikoffBoundExplorer client:load locale="en" />
...
<XorContradictionVisualizer client:load locale="en" />
