...
- **Text understanding and generation**: conversational assistants (GPT, Claude, Gemini, Mistral), summarisation, coding assistants.
...
3. **The renaissance (2012-today)**: ImageNet + GPUs + big data ignite the explosion. AlexNet (2012), transformers (2017), foundation models (2020+).
