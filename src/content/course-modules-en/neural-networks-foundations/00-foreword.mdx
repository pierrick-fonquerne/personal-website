...
<MermaidDiagram
  client:visible
  caption="Eighty years in eight dates"
  definition={`timeline
    title Neural network milestones
    1943 : McCulloch and Pitts
         : Formal neuron model
    1958 : Rosenblatt
         : Perceptron that learns
    1969 : Minsky and Papert
         : XOR limitations
    1986 : Rumelhart, Hinton, Williams
         : Backpropagation
    1998 : LeCun
         : LeNet and convolutional vision
    2012 : Krizhevsky, Sutskever, Hinton
         : AlexNet and the GPU explosion
    2017 : Vaswani et al.
...
<MermaidDiagram
  client:visible
  caption="Logical dependencies: who builds on whom"
