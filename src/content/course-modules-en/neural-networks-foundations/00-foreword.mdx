...
Important to avoid selling a dream. Current limitations as of 2026:
...
Marketing around "artificial intelligence" often exaggerates capabilities. Understanding the mathematical foundations this course gives you is the best antidote to commercial discourse. You will see that a neural network is essentially stacked linear combinations and non-linear functions, not a form of consciousness.
</Callout>
...
Chapter 1 will revisit the historical milestones in detail. Just remember: the theory we study here is old; what is new are the computers and the data.
...
Several chapters contain interactive components: neurons with sliders, manipulable 2D planes, function plotters. **They are not decoration.** Play with the parameters for three minutes before reading on; you will learn faster than from prose alone.
</Callout>
...
- Goodfellow, I., Bengio, Y. & Courville, A. (2016). *Deep Learning*. MIT Press. Chapter 1: *Introduction*. Excellent global overview, free online. [deeplearningbook.org](https://www.deeplearningbook.org/)
...
- Karpathy, A. (YouTube video, 2022). *The spelled-out intro to neural networks and backpropagation: building micrograd*. The best practical explanation in the field. [youtube.com](https://www.youtube.com/watch?v=VMj-3S1tku0)
