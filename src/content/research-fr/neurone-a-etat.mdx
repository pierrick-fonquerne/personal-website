...
La distinction parait mince. Elle ne l'est pas. Tout l'écart entre une porte logique et une cellule vivante tient dans ce mot : **état**. Un neurone à état porte une variable interne qui évolue dans le temps et qui dépend de son histoire. Un neurone sans état n'a que l'instant présent. Nous allons voir, marche après marche, ce que cette mémoire interne débloque.
...
En 1936, Hill va plus loin en couplant le seuil de tir au potentiel sous-seuil : c'est l'**accommodation**, le seuil monte quand le potentiel s'approche lentement. Une seconde variable d'état apparait, et avec elle une vérité simple : le seuil n'est pas une constante, il dépend de ce que le neurone vient de vivre.
...
Le modele de Lapicque n'est qu'un début. Une famille entière de modèles enrichit l'état interne, du plus fidèle au plus économe.
